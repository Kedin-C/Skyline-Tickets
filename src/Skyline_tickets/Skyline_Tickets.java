...
public class Skyline_Tickets {
    ...
    public static void main(String[] args) {
        ...
        Login_controller login_cont = new Login_controller(login,vista_principal,usuario,registro_view,pagina_admin,pagina_usuario);
        ...
        Inicio_usuario_controller pagina_usuario_cont = new Inicio_usuario_controller(pagina_usuario,select_vuelo,buscar_v,info_personal,ticket,usuario);

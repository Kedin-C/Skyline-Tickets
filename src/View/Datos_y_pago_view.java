...
public class Datos_y_pago_view extends Interfaz_vista_abtractas{
    ...
    public Datos_y_pago_view() {
        ...
        nombrecampo.getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_V, Toolkit.getDefaultToolkit().getMenuShortcutKeyMaskEx()), "none");

        //Desactivar el clic derecho
        nombrecampo.setComponentPopupMenu(new JPopupMenu());
        
        apellidocampo.addKeyListener(new KeyAdapter() {
            public void keyTyped(KeyEvent e) {
                if (!Character.isLetter(e.getKeyChar()) && e.getKeyChar() != ' ')//Solo letras y espacios
                {
                    e.consume();
        ...
        //Desactivar el comando de "Pegar" (Ctrl + V)
        apellidocampo.getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_V, Toolkit.getDefaultToolkit().getMenuShortcutKeyMaskEx()), "none");

        //Desactivar el clic derecho
        apellidocampo.setComponentPopupMenu(new JPopupMenu());
        
        numero_documento.addKeyListener(new KeyAdapter() {
            public void keyTyped(KeyEvent e) {
        ...
        //Desactivar el comando de "Pegar" (Ctrl + V)
        numero_documento.getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_V, Toolkit.getDefaultToolkit().getMenuShortcutKeyMaskEx()), "none");

        //Desactivar el clic derecho
        numero_documento.setComponentPopupMenu(new JPopupMenu());
        
        numeroTel.addKeyListener(new KeyAdapter() {
            public void keyTyped(KeyEvent e) {
                if (!Character.isDigit(e.getKeyChar()) && e.getKeyChar() != ' ' && e.getKeyChar() != '+')//Solo numeros espacios y "+"
                {
                    e.consume();
                }
            }
        ...
        //Desactivar el comando de "Pegar" (Ctrl + V)
        numeroTel.getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_V, Toolkit.getDefaultToolkit().getMenuShortcutKeyMaskEx()), "none");

        //Desactivar el clic derecho
        numeroTel.setComponentPopupMenu(new JPopupMenu());
        
        
        //Para que no pueda ingresar al campo de fecha
        JTextField editorFecha = (JTextField) elegir_fecha.getDateEditor().getUiComponent();

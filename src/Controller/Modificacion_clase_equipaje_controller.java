...
public class Modificacion_clase_equipaje_controller implements ActionListener {
    private final Seleccion_de_Modificacion_de_vuelo_view vista_seleccion_clase_equipaje;
    ...
    private final Seleccion_de_vuelo_usuarioNoregistrado_view vista_atras;
    Interfaz_cambio_clase_controller clase_cont;
    ...
    this.vista_seleccion_clase_equipaje.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == vista_seleccion_clase_equipaje.Clase_vuelo){
        ...
        if(e.getSource() == vista_seleccion_clase_equipaje.Equipaje){
            vista_seleccion_clase_equipaje.setVisible(false);
        ...
        if(e.getSource() == vista_seleccion_clase_equipaje.Volver){
            vista_seleccion_clase_equipaje.setVisible(false);
